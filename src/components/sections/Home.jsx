        ...
        <RevealOnScroll>
            <div className="text-center z-10 px-4">
                <h1 className="text-5xl md:text-7xl font-bold mb-6 bg-gradient-to-r from-blue-500 to-cyan-400 bg-clip-text text-transparent leading-right">
                    Hi, I'm William Mason
                </h1>
                <p className="text-gray-400 text-lg mb-8 max-w-lg mx-auto">
                    Established software developer with 3 years of experience, specializing in full-stack development and cloud technologies, who thrives in collaborative environments and is passionate about solving complex problems using innovative solutions.
                </p>
